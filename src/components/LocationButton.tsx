    ...
    const checkPermission = async () => {
      if ("permissions" in navigator) {
        try {
          ...
          (result as any).addEventListener?.("change", () => {
            setPermissionStatus((result as any).state);
          });
        } catch (err) {
  ...
  const getCurrentLocation = async () => {
    ...
    try {
      ...
      if (!navigator.geolocation) {
        throw new Error(
          "Geolocation is not supported by this browser. Please use a modern browser like Chrome, Safari, or Firefox.",
        );
      }
              ...
              <div className="space-y-4">
                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                  ...
                  <div className="text-sm text-red-600 space-y-1">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2">
                      ...
                      <li>
                        Ensure your browser has permission to access your
                        location
                      </li>
                      <li>
                        Try refreshing the page and clicking "Allow" when
                        prompted
                      </li>
                ...
                <div className="bg-blue-50 p-3 rounded-lg border-l-4 border-blue-400">
                  <p className="text-sm text-blue-700">
                    <strong>Alternative:</strong> You can still call us directly
                    at{" "}
                    <a
