...
const Hero = () => {
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-tr from-black/60 via-primary/40 to-transparent dark:from-black/70 dark:via-primary/30" />
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-14">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="text-lg px-8 bg-white/10 border-white/30 border-2 text-white hover:bg-secondary hover:border-secondary hover:text-primary backdrop-blur-md"
            >
